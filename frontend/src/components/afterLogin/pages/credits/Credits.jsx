            ...
            <div className={styles.creditsContainer}>
                <div className={styles.alignContainer}>
                    ...
                    <form className={styles.formStyle} onSubmit={handleSubmit}>
                        ...
                        <GeneralForm showText={"Numer wniosku"} name={"applicationNumber"} type={"number"}
                                     maxLength={26}
                        ...
                        <div className={styles.twoSides}>
                            <div className={styles.side}>
                                ...
                                <GeneralForm showText={"Drugie imie"} name={"secondName"} type={"text"} maxLength={40}
                                             minLength={0}
                                             required={false}/>
                                <GeneralForm showText={"PESEL"} name={"pesel"} type={"number"} maxLength={11}
                                             minLength={0}
                                             required={true}/>
                                <GeneralForm showText={"Nr. telefonu"} name={"phoneNumber"} type={"number"}
                                             maxLength={9}
                                             minLength={0}
                                             required={true}/>
                                ...
                                <GeneralForm showText={"Dokument tożsamości"} name={"identityCard"} type={"text"}
                                             maxLength={9}
                                             minLength={0} required={true}/>
                                <GeneralForm showText={"Ważny do"} name={"identityCardExpired"} type={"date"}
                                             maxLength={40}
                                             minLength={0} required={true}/>
                            ...
                            <div className={styles.side}>
                                ...
                                <GeneralForm showText={"Numer NIP"} name={"nip"} type={"number"} maxLength={20}
                                             minLength={0}
                                             required={true}/>
                                <GeneralForm showText={"Kod pocztowy miejsca pracy"} name={"workPostcardCode"}
                                             type={"text"}
                                ...
                                <GeneralForm showText={"Stanowisko"} name={"position"} type={"text"} maxLength={40}
                                             minLength={0}
                                             required={true}/>
                                <GeneralForm showText={"Średni miesięczny dochód brutto"} name={"income"}
                                             type={"number"}
                        ...
                        <GeneralForm showText={"Ilość osób na utrzymaniu"} name={"maintenance"} type={"number"}
                                     maxLength={20}
                                     minLength={0} required={true}/>
                        <GeneralForm showText={"Wysokość miesięcznych wydatków"} name={"spending"} type={"number"}
                                     maxLength={40}
                                     minLength={0} required={true}/>
                        <GeneralForm showText={"Okres trwania kredytu (msc.)"} name={"startDate"} type={"number"}
                                     maxLength={40}
                                     minLength={0} required={true}/>
